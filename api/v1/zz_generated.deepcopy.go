...
func (in *Stage) DeepCopyInto(out *Stage) {
	*out = *in
	if in.TaskTemplateReferences != nil {
		in, out := &in.TaskTemplateReferences, &out.TaskTemplateReferences
		*out = make([]TaskTemplateReference, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *TaskTemplateReference) DeepCopyInto(out *TaskTemplateReference) {
	*out = *in
	...
	if in.TaskVariableConfigMap != nil {
		in, out := &in.TaskVariableConfigMap, &out.TaskVariableConfigMap
		*out = new(TaskVariableConfigMap)
		**out = **in
	}
	if in.TaskVariablesMap != nil {
		in, out := &in.TaskVariablesMap, &out.TaskVariablesMap
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TaskVariableConfigMap) DeepCopyInto(out *TaskVariableConfigMap) {
	*out = *in
	out.ObjectReference = in.ObjectReference
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TaskVariableConfigMap.
func (in *TaskVariableConfigMap) DeepCopy() *TaskVariableConfigMap {
	if in == nil {
		return nil
	}
	out := new(TaskVariableConfigMap)
